...
def getDataframes():
    ...
    URM_path = 'RecSys_Challenge2021/data/data_train.csv'
    ...
    ICM_genre_path = 'RecSys_Challenge2021//data/data_ICM_genre.csv'
    ...
    ICM_subgenre_path = 'RecSys_Challenge2021//data/data_ICM_subgenre.csv'
    ...
    ICM_channel_path = 'RecSys_Challenge2021//data/data_ICM_channel.csv'
    ...
    ICM_event_path = 'RecSys_Challenge2021//data/data_ICM_event.csv'
...
def getURMWeighted():
    URM_path = 'RecSys_Challenge2021/data/URM_wgh.csv'
...
def getICMlength(param = "3bal"):
    ICM_length_path = 'RecSys_Challenge2021/data/ICM_' + param + '_length.csv'
...
def getICMselected(param = "7"):
    ICM_length_path = 'RecSys_Challenge2021/data/ICM_selected_' + str(param) + '.csv'
    ICM_length_all_dataframe = pd.read_csv(filepath_or_buffer=ICM_length_path)
    ICM_length_all = sps.coo_matrix(ICM_length_all_dataframe)
    return ICM_length_all
