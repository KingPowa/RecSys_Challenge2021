...
if __name__ == '__main__':
    ...
    '''
    URM_all = URM_all.todense()[:2000, :]
    print(URM_all.shape)
    URM_all = coo_matrix(URM_all)
    '''
    ...
    output_folder_path = "../result_experiments/S_SLIM_ElasticNet_genre_subgenre_channel_5km_3"
    ...
    hyperparameters_range_dictionary = {
        "ICM_weight": Integer(2,5),
        "topK": Integer(2000, 5000),
    }
