...
if __name__ == "__main__":
    ...
    from Recommenders.KNN.ItemKNNScoresHybridMultipleRecommender import ItemKNNScoresHybridMultipleRecommender2
    ...
    recommender_class = ItemKNNScoresHybridMultipleRecommender2
    ...
    recommender_input_args = SearchInputRecommenderArgs(
        CONSTRUCTOR_POSITIONAL_ARGS = [URM_train, recommender1, recommender2],     # For a CBF model simply put [URM_train, ICM_train]
    ...
    ofp_hyp = ofp + "hypersearch_noIALS/"
