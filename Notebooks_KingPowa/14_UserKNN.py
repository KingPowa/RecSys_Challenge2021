...
output_folder_path = "../result_experiments/UserKNN/"
...
URM_train, URM_validation = split_train_in_two_percentage_global_sample(URM_all, train_percentage = 0.8, seed=1256)
...
hyperparameters_range_dictionary = {
    "topK": Integer(100, 900),
    "similarity": Categorical(['cosine']),
    "shrink": Integer(300, 1100),
